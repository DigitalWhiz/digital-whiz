    ...
    <section className='testimonial py-10 px-4 sm:px-6 lg:px-8'>
      <div className='container mx-auto relative'>
        <div className='heading-title mb-8 text-center'>
          <TitleLogo  title="" caption='LO QUE DICEN LOS CLIENTES SOBRE NUESTRO TRABAJO' className="text-9xl text-shadow-lg" />
              ...
              <div key={user.id} className='p-4'>
                <div className='card bg-white rounded-lg shadow-md overflow-hidden'>
                  ...
                  <div className='details p-4'>
                    ...
                    <Link href='https://wa.me/message/XWKCRXJ2NSCII1' className='flex items-center mt-4 text-blue-500 hover:underline'>
